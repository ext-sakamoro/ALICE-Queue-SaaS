...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['1M messages/mo', '3 queues', '7-day retention', 'Community support'] },
  { name: 'Pro', price: '$59/mo', features: ['100M messages/mo', 'Unlimited queues', 'Dead letter queues', 'Zero-copy delivery', '30-day retention', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited messages', 'Custom retention', 'Multi-region', 'FIFO guarantee', 'SLA 99.99%', 'Dedicated support'] },
];
